    ...
    <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
      {nonZeroRatings.map(([rating, count]) => (
        <div key={rating} className="flex items-center gap-1 min-w-0">
          ...
          <span className="text-xs text-neutral-500 hidden sm:inline whitespace-nowrap">
  ...
  if (sortedDays.length === 0) {
    return (
      <div className={`text-center py-8 ${className}`}>
        ...
        <p className="text-neutral-500">No review history available yet.</p>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="w-full px-3 sm:px-4 py-3 text-left hover:bg-neutral-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                ...
                <div className="px-4 pb-4">
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {dayData.flashcards.map((card) => (
                      <div
                        key={card.id}
                        className="flex items-center justify-between p-2 bg-neutral-50 rounded-md gap-2"
                      >
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          ...
                          <div className="text-xs text-neutral-500 min-w-[2.5rem] text-right font-mono">
